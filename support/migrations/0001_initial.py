# Generated by Django 3.2.5 on 2023-12-10 10:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.ManyToManyField(blank=True, related_name='issue_comments', to='support.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('issues', models.ManyToManyField(blank=True, related_name='project_issues', to='support.Issue')),
            ],
        ),
        migrations.AddField(
